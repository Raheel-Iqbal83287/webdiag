    ...
    <div className={`max-w-4xl mx-auto ${isPro ? "relative" : ""}`}>
      ...
      <div className={`text-center mb-12 ${isPro ? "pro-hero -mx-6 px-6 py-16 rounded-3xl border border-indigo-500/10" : ""}`}>
        ...
        <h1 className={`text-5xl font-extrabold mb-4 tracking-tight ${isPro ? "text-white" : "text-slate-900"}`}>
          Scan. Analyze. <span className="relative"><span className={isPro ? "text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400" : "gradient-text"}>Fix.</span>{!isPro && <span className="absolute -top-4 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-indigo-600 text-white text-[9px] font-bold uppercase tracking-wider rounded whitespace-nowrap z-10">Pro Feature</span>}</span>
        </h1>
