...
const tiers = [
  {
    ...
    modules: 4,
    export: "None",
    features: ["4 basic audit modules", "3 scans per month", "Local folder upload"],
    highlighted: false,
    cta: "Start Free",
    color: "emerald",
  },
  {
    ...
    modules: 8,
    export: "JSON, TXT",
    features: ["8 audit modules", "20 scans per month", "Local folder upload", "JSON & TXT export"],
    highlighted: false,
    cta: "Choose Starter",
    color: "indigo",
  },
  {
    ...
    modules: 12,
    export: "JSON, DOC, TXT",
    features: ["12 audit modules", "50 scans per month", "Local folder upload", "JSON, DOC & TXT export"],
    highlighted: true,
    cta: "Choose Plus",
    color: "purple",
  },
  {
    ...
    features: ["All 16 audit modules", "Unlimited scans", "Local folder upload", "JSON, PDF, DOC & TXT export"],
    highlighted: false,
    cta: "Choose Pro",
    color: "amber",
  },
